...
class DataIngestionConfig:
    train_data_path:str=os.path.join("artifacts", "book.csv")
    test_data_path:str=os.path.join("artifacts", "book1.csv") 
    raw_data_path:str=os.path.join("artifacts", "book2.csv")
